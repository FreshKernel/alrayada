...
import '../../common/services/notifications/s_notifications.dart';
...
class RemoteUserApi extends UserApi {
  ...
  Future<UserCredential?> fetchSavedUserCredential() async {
    try {
      ...
      // If the saved user is not valid for some reason then we will remove the data
      logout();
      throw UnknownUserException(message: e.toString());
    }
  }
