    ...
    return SettingsSection(
      ...
      tiles: [
        ListTile(
          ...
          trailing: DropdownMenu<AppLocalization>(
            initialSelection: state.appLanguague,
            dropdownMenuEntries: AppLocalization.values
                .map(
                  (e) => DropdownMenuEntry<AppLocalization>(
                    value: e,
                    label: e.labelText.replaceFirst(
                      AppLocalization.system.labelText,
                      context.loc.system,
                    ),
                  ),
                )
