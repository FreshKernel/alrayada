...
fun Route.deleteUserAccount() {
    ...
    authenticate {
        delete("/deleteUser") {
            val currentAdminUser = call.requireCurrentAdminUser() // Important
            ...
            if (currentAdminUser.id.toString() == userId) {
                throw ErrorResponseException(
    ...
    authenticate {
        patch("/setAccountActivated") {
            ...
            val isAccountActivatedNew =
                requestBody["isAccountActivated"]?.toBooleanStrictOrNull() ?: throw ErrorResponseException(
                    HttpStatusCode.BadRequest,
            ...
            if (currentIsAccountActivated == null) {
                throw ErrorResponseException(
                    ...
                    "We can't find this user or the isAccountActivated property",
                    "MISSING_DATA"
                )
            }
